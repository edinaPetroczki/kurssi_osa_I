...
<html lang="fi-FI">
    ...
    <div id="title">
        ...
        <div class="row">
            <div class="column">
                <img id="profile-picture" src="Kuvat/profile_picture.jpg" alt="Hymyilevä nainen hatussa, huivissa ja takissa talvimaisema taustalla">
            </div>
            <div class="column">
                <h2>Perustiedot</h2>
        ...
        <div id="main-text">
            <h2>Oma kuvaus</h2>
                <p>
                    Olen vastavalmistunut ohjelmistokehittäjä, jolla on utelias mieli ja erinomaiset ongelmanratkaisutaidot. Harjoittelijana <a class="link" href="https://www.nokia.com/" target="_blank">Nokia</a>lla kokeilin ohjelmistokehityksen alaa ja sain vahvistuksen soveltuvuudestani ammattiin.
                </p>
                <p>
        ...
        <div id="lista">
            ...
            <ul>
                ...
                <li>Koodaaminen</li>
                <li>Lukeminen</li>
                <li>Vapaaehtoistyö <a class="link" href="https://www.hesy.fi/" target="_blank">HESY</a>:ssä</li>
            </ul>
        </div>
        <div>
        ...
        <div>
            <form action="" method="post">
                <fieldset>
                    ...
                    <label id="sukupuoli">Sukupuoli</label><br>
